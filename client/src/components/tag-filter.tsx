...
export function TagFilter({
  ...
  return (
    <div className={className}>
      ...
      {/* Filter trigger styled as tab */}
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button
            variant="ghost"
            size="sm"
            className={`rounded-none border-b-2 hover:bg-zinc-900 border-transparent text-zinc-400 hover:text-zinc-100 flex items-center gap-2`}
